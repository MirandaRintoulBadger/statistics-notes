...
knitr::include_graphics("figs/comics/ch7.jpeg")
```
...
```{r, echo = F}
x <- seq(1.2, 1.8, by = .001)
null <- dnorm(x, mean = 1.5, sd = .061)
alt <- dnorm(x, mean = 1.6, sd = .061)
plot(x, null, type = "l", ylim = c(0, 7), yaxt = "n",
     ylab = "", xlab = expression(bar("X")),
...
plot(x, null, type = "l", ylim = c(0, 7), yaxt = "n",
     ylab = "", xlab = expression(bar("X")),
     col = "darkorange2", lwd = 2) +
        lines(x, alt, col = "forestgreen", type = "l",
              lwd = 2, lty = 3)
legend(1.2, 7, legend = c("Null", "Alt"), lwd = c(2, 2),
       col = c("darkorange2", "forestgreen"), lty = c(1, 3))
```
...
lines(x, alt, col = "forestgreen", type = "l",
      lwd = 2, lty = 3)
polygon(c(x[x>=1.62], 1.62), c(null[x>=1.62], null[x==max(x)]), col="darkorange1")
polygon(c(x[x<=1.38], 1.38), c(null[x<=1.38], null[x==max(x)]), col="darkorange1")
abline(v = 1.38, lwd = 2, lty = 2, col = "darkorange2")
abline(v = 1.62, lwd = 2, lty = 2, col = "darkorange2")
legend(1.2, 7, legend = c("Null", "Alt"), lwd = c(2, 2),
       col = c("darkorange2", "forestgreen"), lty = c(1, 3))
```
...
lines(x, alt, col = "forestgreen", type = "l",
      lwd = 2, lty = 3)
polygon(c(x[x>=1.62], 1.62), c(alt[x>=1.62], alt[x==max(x)]), col="forestgreen")
polygon(c(x[x<=1.38], 1.38), c(alt[x<=1.38], alt[x==max(x)]), col="forestgreen")
abline(v = 1.38, lwd = 2, lty = 2, col = "darkorange2")
abline(v = 1.62, lwd = 2, lty = 2, col = "darkorange2")
legend(1.2, 7, legend = c("Null", "Alt"), lwd = c(2, 2),
       col = c("darkorange2", "forestgreen"), lty = c(1, 3))
...
legend(1.2, 7, legend = c("Null", "Alt"), lwd = c(2, 2),
       col = c("darkorange2", "forestgreen"), lty = c(1, 3))
text(1.35, 2, "1.38", col = "darkorange")
text(1.65, 2, "1.62", col = "darkorange")
```
...
abline(v = 2.664, lwd = 2, col = "dodgerblue", lty = 2)
```
