...
knitr::include_graphics("figs/comics/ch8.jpg")
```
...
plot(x, y, type = "l",
     ylab = "", yaxt = "n", xlab = "", 
     main = "Null distribution + Test stat")
segments(-3.656, 0, -3.656, .4, lty = 3, lwd = 3, col = "dodgerblue")
```
...
```{r, echo = F}
x <- 0:11
y <- dbinom(0:11, 11, 0.5)

# Basic null dist
plot(x, y, type = "h", lwd = 3, yaxt = "n", ylab = "",
     xlab = "Count of values above 4.6", ylim = c(0, 0.3),
...
plot(x, y, type = "h", lwd = 3, yaxt = "n", ylab = "",
     xlab = "Count of values above 4.6", ylim = c(0, 0.3),
     main = "Null distribution")
  abline(v = 5, lty = 2, lwd = 2, col = "dodgerblue") +
  text(6.3, 0.27, labels = "b = 5", col = "dodgerblue")
```
...
# Basic null dist + test stat + pvalue
plot(x, y, type = "h", lwd = 3, yaxt = "n", ylab = "",
     xlab = "Stronger evidence against H0 ->", ylim = c(0, 0.3),
     main = "Null distribution",
     col = c(rep("black", 5), rep("dodgerblue3", 7))) +
  abline(v = 5, lty = 2, lwd = 2, col = "dodgerblue") +
  text(6.3, 0.27, labels = "b = 5", col = "dodgerblue")
```
...
plot(x, y, type = "h", lwd = 3, yaxt = "n", ylab = "",
     xlab = "Stronger evidence against H0 ->", ylim = c(0, 0.3),
     main = "Null distribution",
     col = c(rep("black", 9), rep("dodgerblue3", 3))) +
  abline(v = 9, lty = 2, lwd = 2, col = "dodgerblue") +
  text(10.3, 0.27, labels = "b = 9", col = "dodgerblue")
```
