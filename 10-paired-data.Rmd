...
knitr::include_graphics("figs/comics/ch10.png")
```
...
# standard/varied points on the x axis
ones <- rep(1, 8)
twos <- rep(2, 8)

# Plot all points
plot(c(ones, twos), c(standard, varied),
     ylim = c(50, 100), xlim = c(0.8, 2.2),
     xaxt = "n", xlab = "", ylab = "Percentage")
# Change x-axis labels
axis(1, at = c(1, 2), labels = c("Standard", "Varied"))
# Create lines to join all 8 pairs of points
for(i in 1:8){
        lines(c(1, 2), c(standard[i], varied[i]))
}
```
