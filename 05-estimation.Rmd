...
knitr::include_graphics("figs/comics/ch5.png")
```
...
barplot(c(0.04, 0.32, 0.64),
        names = c(0, 2, 4), main = "Distribution A")
barplot(c(0.04, 0.16, 0.32, 0.32, 0.16),
        names = 0:4, main = "Distribution B")
barplot(c(0.36, 0.48, 0.16),
        names = c(0, 1.41, 2.83), main = "Distribution C")
barplot(c(0.04, 0.16, 0.32, 0.32, 0.16),
        names = c(0, 2, 4, 6, 8), main = "Distribution D")
...
```{r,echo=F}
knitr::include_graphics("figs/est/bias-variance.png")
```
...
plot(x, dnorm(x), type = "l", lwd = 2,
    yaxt = "n", ylab = "", main = "Population")
abline(v = 0, lwd = 2, lty = 2, col = "red")
text(0.7, 0.055, "pop mean", col = "red")
hist(samp, xlim = c(-4, 4), ylim = c(0, 3), yaxt = "n",
    ylab = "", main = "Sample, n = 5", breaks = 15)
abline(v = mean(samp), lwd = 2, col = "blue", lty = 2)
text(1, 2.5, "sample mean", col = "blue")
...
text(0.7, 0.055, "pop mean", col = "red")
hist(samp, xlim = c(-4, 4), ylim = c(0, 3), yaxt = "n",
    ylab = "", main = "Sample, n = 5")
abline(v = mean(samp), lwd = 2, col = "blue", lty = 2)
text(0.4, 2.5, "sample mean", col = "blue")
...
hist(samp, xlim = c(-4, 4), ylim = c(0, 3), yaxt = "n",
    ylab = "", main = "Sample, n = 5")
abline(v = mean(samp), lwd = 2, col = "blue", lty = 2)
text(1.3, 2.5, "sample mean", col = "blue")
...
plot(x, dnorm(x), type = "l", lwd = 2, ylim = c(0, 1),
    yaxt = "n", ylab = "", main = " ")
text(2, 0.25, "Population")
curve(dnorm(x, 0, 1/sqrt(5)), add = T,
      lwd = 2, lty = 2, col = "blue")
text(1.5, 0.6, "Sample Mean", col = "blue")
```
...
```{r, echo = F}
x <- seq(0.88, 1.9, by = 0.01)

plot(x, dnorm(x, 1.39, 0.161), type = "l", lwd = 2, ylim = c(0, 20),
    yaxt = "n", ylab = "", main = " ", xlab = "Weight")
curve(dnorm(x, 1.39, 0.161/sqrt(5)), add = T,
      lwd = 2, lty = 2, col = "blue3")
curve(dnorm(x, 1.39, 0.161/sqrt(50)), add = T,
      lwd = 2, lty = 3, col = "dodgerblue")
text(1.75, 2, "Population")
text(1.55, 4, "Mean of 5", col = "blue3")
text(1.52, 10, "Mean of 50", col = "dodgerblue")
abline(v = 1.2, lty = 3)
```
...
bimod <- c(rnorm(10, -1, 0.5), rnorm(10, 1, 0.5))
right <- rbeta(20, 3, 1)
left <- rchisq(16,1)

par(mfrow = c(1, 2))
qqnorm(bimod, main = "Bimodal QQ-Plot"); qqline(bimod)
hist(bimod, main = "Bimodal Histogram", col = "dodgerblue")
qqnorm(right, main = "Left-Skewed QQ-Plot"); qqline(right)
hist(right, main = "Left-Skewed Histogram", col = "dodgerblue")
qqnorm(left, main = "Right-Skewed QQ-Plot"); qqline(left)
hist(left, main = "Right-Skewed Histogram", col = "dodgerblue")
```
...
mean5 <- numeric(10000)
mean20 <- numeric(10000)

for(i in 1:10000){
  mean5[i] <- mean(rgamma(5, 2, 0.5))
  mean20[i] <- mean(rgamma(20, 2, 0.5))
}

x <- seq(0, 12, by = 0.01)
plot(x, dgamma(x, 2, 0.5), type = "l",
    lwd = 2, xlim = c(0, 12), yaxt = "n",
    main = "Population")

hist(mean5, main = "Sampling Dist of Mean, n = 5",
    yaxt = "n", xlim = c(0, 12))

hist(mean20, main = "Sampling Dist of Mean, n = 20",
    yaxt = "n", xlim = c(0, 12))
