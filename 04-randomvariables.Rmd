...
```{r,echo=F, out.height="450px", fig.align="center"}
knitr::include_graphics("figs/comics/ch4.png")
```
...
```{r,echo=F}
knitr::include_graphics("figs/rvs/371_notes4.png")
```
...
par(mfrow = c(1, 2))
barplot(c(0.05, 0.1, 0.15, 0.25, 0.2, 0.15, 0.1),
        yaxt = "n", ylab = "", xlab = "", axes = F,
        names = 0:6, main = "Discrete Population",
        col = "tomato", ylim = c(0, 0.3))
...
```{r, echo=F}
barplot(c(0.001, 0.006, 0.007, 0.008, 0.012, 0.02,
          0.038, 0.099, 0.319, 0.437, 0.053),
        names = 0:10, main = "X = Apgar Score",
        col = "tomato", ylim = c(0, 0.5))
```
...
```{r, echo=F}
barplot(c(0.084, 0.323, 0.415, 0.178),
        names = 0:3, main = "X = RY Offspring out of 3",
        col = "tomato", ylim = c(0, 0.5))
```
...
```{r, echo=F}
barplot(dbinom(0:10, 10, 0.7), names = 0:10,
        main = "X ~ Binom(n = 10, pi = 0.7)",
        col = "tomato", ylim = c(0, 0.5))
```
...
```{r, echo=F}
barplot(dbinom(0:10, 10, 0.1), names = 0:10,
        main = "X ~ Binom(n = 10, pi = 0.1)",
        col = "tomato", ylim = c(0, 0.5))
```
...
```{r, echo=F}
barplot(dbinom(0:20, 20, 0.5), names = 0:20,
        main = "X ~ Binom(n = 20, pi = 0.5)",
        col = "tomato", ylim = c(0, 0.5))
```
...
library(truncnorm)
t <- seq(9, 16, by = .01)
plot(t, dtruncnorm(t, 10, 15, 13.5, 1.5), type = "l", lwd = 2,
     ylab = "", main = "Driving Time (minutes)", 
     yaxt = "n", ylim = c(0, 0.4))
```
...
plot(t, dtruncnorm(t, 10, 15, 13.5, 1.5), type = "l", lwd = 2,
     ylab = "", main = "Driving Time (minutes)", 
     yaxt = "n", ylim = c(0, 0.4))
polygon(c(t[t>=10], 10, 10),
        c(dtruncnorm(t, 10, 15, 13.5, 1.5)[t>=10], 0, 0),
        col="dodgerblue")
```
...
plot(t, dtruncnorm(t, 10, 15, 13.5, 1.5), type = "l", lwd = 2,
     ylab = "", main = "Driving Time (minutes)", 
     yaxt = "n", ylim = c(0, 0.4))
polygon(c(12, seq(12, 14, by = 0.01), 14),
        c(0, dtruncnorm(seq(12, 14, by = 0.01), 10, 15, 13.5, 1.5), 0),
        col = "dodgerblue")
```
...
plot(t, dtruncnorm(t, 10, 15, 13.5, 1.5), type = "l", lwd = 2,
     ylab = "", main = "Driving Time (minutes)", 
     yaxt = "n", ylim = c(0, 0.4))
polygon(c(12, seq(12, 12, by = 0.01), 12),
        c(0, dtruncnorm(seq(12, 12, by = 0.01), 10, 15, 13.5, 1.5), 0),
        col = "dodgerblue")
```
...
```{r, echo=F}
x <- seq(60, 80, by = .01)
plot(x, dnorm(x, 70, 3), type = "l", lwd = 2,
     ylab = "", main = "Heights of US Males (in)", 
     yaxt = "n", ylim = c(0, 0.2))
```
...
plot(x, dnorm(x, 70, 3), type = "l", lwd = 2,
     ylab = "", main = "Heights of US Males (in)", 
     yaxt = "n", ylim = c(0, 0.2))
polygon(c(x[x<=72], 72, 72), c(dnorm(x, 70, 3)[x<=72], 0, 0), col="dodgerblue")
```
...
x <- seq(-5, 5, by = 0.01)
plot(x, dnorm(x), type = "l", lwd = 2,
     ylab = "", yaxt = "n", ylim = c(0, 0.9),
     main = expression(paste("N(", mu, " = 0, ", sigma^2, " = 1)")))
```

This normal RV has a lower center and more spread.

```{r, echo=F}
plot(x, dnorm(x, -1, sqrt(2)), type = "l", lwd = 2,
     ylab = "",
     yaxt = "n", ylim = c(0, 0.9),
     main = expression(paste("N(", mu, " = -1, ", sigma^2, " = 2)")))
```

This normal RV has a higher center and less spread.

```{r, echo=F}
plot(x, dnorm(x, 2, 0.5), type = "l", lwd = 2,
     ylab = "",
     yaxt = "n", ylim = c(0, 0.9),
     main = expression(paste("N(", mu, " = 2, ", sigma^2, " = 0.25)")))
```
...
```{r,echo=F}
knitr::include_graphics("figs/rvs/empirical_rule.png")
```
...
plot(z, dnorm(z), type = "l", lwd = 2,
     ylab = "", main = "Standard Normal", 
     yaxt = "n", ylim = c(0, 0.6))
polygon(c(z[z<=2/3], 2/3, 2/3), c(dnorm(z)[z<=2/3], 0, 0), col="tomato")
par(mfrow = c(1,1))
```
...
plot(x, dnorm(x, 70, 3), type = "l", lwd = 2,
     ylab = "", main = "Heights of US Males (in)", 
     yaxt = "n", ylim = c(0, 0.2))
polygon(c(72, 72, 72), c(dnorm(72, 70, 3), 0, 0), col="dodgerblue")
```
...
```{r, echo=F}
x <- seq(15.1, 17.1, by = .01)
plot(x, dnorm(x, 16.1, 0.3), type = "l", lwd = 2,
     ylab = "", main = "Package Weights (oz)", 
     yaxt = "n", ylim = c(0, 2), xaxt = "n")
axis(1, at = seq(15.2, 17, by = 0.3))
segments(16, 0, 16, dnorm(16, 16.1, 0.3), lty = 2, lwd = 2)
```
...
```{r, echo=F}
x <- seq(13.1, 17.1, by = .01)
plot(x, dnorm(x, 16.1, 0.3), type = "l", lwd = 2,
     ylab = "", main = "Package Weights (oz)", 
     yaxt = "n", ylim = c(0, 2), xaxt = "n", xlim = c(15.1, 17.1))
axis(1, at = seq(15.2, 17, by = 0.3))

polygon(c(x[x<=16.5], 16.5, 16.5), c(dnorm(x, 16.1, 0.3)[x<=16.5], 0, 0),
col="dodgerblue")

polygon(c(x[x<=15.5], 15.5, 15.5), c(dnorm(x, 16.1, 0.3)[x<=15.5], 0, 0),
col="#A5D2FF")
...
x <- seq(-4, 4, by = 0.01)
plot(x, dnorm(x), type = "l", lwd = 2,
     ylab = "", main = "qnorm finds an x value", 
     yaxt = "n", ylim = c(0, 0.6))
polygon(c(x[x<=0.842], 0.842, 0.842), c(dnorm(x)[x<=0.842], 0, 0),
col="goldenrod1")
text(x = -0.2, y = 0.2,
     label = "Given", font = 2)
abline(v = 0.842, lty = 2, lwd = 2, col = "dodgerblue")
text(x = 1.2, y = 0.5,
     label = "?", font = 2, col = "dodgerblue")
```
...
x <- seq(-4, 4, by = 0.01)
plot(x, dnorm(x), type = "l", lwd = 2,
     ylab = "", main = "pnorm finds an area/probability", 
     yaxt = "n", ylim = c(0, 0.6))
polygon(c(x[x<=0.842], 0.842, 0.842), c(dnorm(x)[x<=0.842], 0, 0),
col="goldenrod1")
text(x = -0.2, y = 0.2,
     label = "?", font = 2)
abline(v = 0.842, lwd = 2)
text(x = 1.3, y = 0.5,
     label = "Given", font = 2)
```
